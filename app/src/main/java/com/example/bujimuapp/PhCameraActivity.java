...
public class PhCameraActivity extends AppCompatActivity {
    ...
    private class ImageTask extends AsyncTask<Void, Void, Exception> {
        ...
        private PhCameraActivity.ImageResponse imageResponse;

        ImageTask(Bitmap photo, PhCameraActivity.ImageResponse imageResponse) {
            this.photo = photo;
...
//                    .show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ph_camera);
    ...
    private static Size chooseOptimalSize(Size[] choices, int width, int height) {
        ...
        if (bigEnough.size() > 0) {
            return Collections.min(bigEnough, new PhCameraActivity.CompareSizeByArea());
